    ...
    <div class="container">
        ...
        <form action="{{ route('resume.index') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea name="kinerja_dokter" id="kinerja_dokter" class="form-control" rows="3">{{ old('kinerja_dokter') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="kinerja_operasional" id="kinerja_operasional" class="form-control" rows="3">{{ old('kinerja_operasional') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="penyakit_terbanyak" id="penyakit_terbanyak" class="form-control" rows="3">{{ old('penyakit_terbanyak') }}</textarea>
