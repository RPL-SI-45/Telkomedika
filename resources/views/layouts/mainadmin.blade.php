...
<body>
    ...
    <div style="position: absolute; right: 20px; top: 20px;">
        <a href="/admin/home" style="color: white; text-decoration: none; border-bottom: none; transition: font-weight 0.3s;" onmouseover="this.style.fontWeight='bold';" onmouseout="this.style.fontWeight='normal';">Dashboard</a>
    </div>
    @yield('main-section')
</body>
</html>
