...
<body class="bg-gray-100">
    ...
    <div class="bg" style="height: 60px; background-color: #B6252A">
            ...
            <div class="d-flex align-items-center">
                ...
                <div x-data="{show: false}" x-on:click.away="show = false" class="relative">
                    ...
                    <div x-show="show" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                            <a href="{{ url('/admin/profile') }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>
    ...
    <div class="flex">
        ...
        <div class="bg-gray-800 text-white w-64 space-y-6 py-7 px-2">
            ...
            <nav class="space-y-2">
                <a href="/admin/home" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-house-door-fill mr-3"></i> Dashboard
                </a>
                <a href="/poli" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-house-fill mr-3"></i> Informasi Poli
                </a>
                <a href="/informasidokter" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-person-badge mr-3"></i> Informasi Dokter
                </a>
                <a href="/rumahsakit" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                <i class="bi bi-building mr-3"></i> Informasi Rumah Sakit
                </a>
                <a href="/antrian/create" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-calendar-check-fill mr-3"></i> Reservasi Online
                </a>
                <a href="/daftarreservasi" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-people-fill mr-3"></i> Antrian Pasien
                </a>
                <a href="/rekammedis" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
        ...
        <div class="flex-1 p-6 bg-white">
            <div class="relative">
                <img src="https://via.placeholder.com/1200x300" class="w-full h-64 object-cover rounded-lg" alt="Banner Image">
                <div class="absolute top-0 left-0 w-full h-full bg-gray-900 bg-opacity-50 rounded-lg flex items-center justify-center">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        <div class="p-4 bg-white shadow-md rounded-lg text-center">
                            <a href="#">
                                <i class="bi bi-folder-fill text-4xl"></i>
                                <h3 class="mt-2 text-lg font-semibold">Rekam Medis Keseluruhan</h3>
                            </a>
                        </div>
                        <div class="p-4 bg-white shadow-md rounded-lg text-center">
                            <a href="#">
                                <i class="bi bi-person-badge-fill text-4xl"></i>
                                <h3 class="mt-2 text-lg font-semibold">Check-in Dokter</h3>
                            </a>
                        </div>
                        <div class="p-4 bg-white shadow-md rounded-lg text-center">
                            <a href="#">
                                <i class="bi bi-star-fill text-4xl"></i>
                                <h3 class="mt-2 text-lg font-semibold">Rating dan Ulasan</h3>
                            </a>
                        </div>
                    </div>
                </div>
