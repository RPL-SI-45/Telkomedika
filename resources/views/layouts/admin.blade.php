            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center relative">
                    ...
                    <div x-data="{ show: false }" x-on:click.away="show = false" class="ml-3 relative">
                        ...
                        <div x-show="show" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-50" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
    ...
    <div class="flex">
        ...
        <div class="bg-gray-800 text-white w-64 space-y-6 py-7 px-2">
            ...
            <nav class="space-y-2">
                ...
                <a href="#" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-calendar-check-fill mr-3"></i> Jadwal Dokter
                </a>
                <a href="#" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-house-fill mr-3"></i> Poli
                </a>
                <a href="#" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                ...
                <a href="#" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-journal-text mr-3"></i> Pelaporan dan Analisis
                </a>
            </nav>
        </div>
