...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <div class="bg-gray-800 text-white w-64 space-y-6 py-7 px-2">
            ...
            <nav class="space-y-2">
                <a href="/home" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-house-door-fill mr-3"></i> Dashboard
                </a>
                <a href="/polipasien" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-house-fill mr-3"></i> Informasi Poli
                </a>
                <a href="/informasi" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-person-badge mr-3"></i> Informasi Dokter
                </a>
                <a href="/lihatrumahsakit" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                <i class="bi bi-building mr-3"></i> Informasi Rumah Sakit
                </a>
                <a href="/reservasi/create" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-calendar-check-fill mr-3"></i> Reservasi Online
                </a>
                <a href="/antrian" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
                    <i class="bi bi-people-fill mr-3"></i> Antrian Pasien
                </a>
                <a href="/medicalrecords" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 hover:text-white">
