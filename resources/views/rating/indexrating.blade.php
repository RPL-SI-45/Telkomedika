            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3" style="background-color: #B6252A;">
                        ...
                        <div></div>
                            <a class="btn btn-secondary" href="/rating/createrating" style="background-color: #C0C0C0; color: black;">Beri Rating dan Ulasan</a>
                        </div>
                    </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    <div class="card shadow-sm" style="background-color:#C0C0C0; height: 100%; border: 0px solid black;">
                                        <div class="card-body text-center">
                                            <h5 class="card-text" style="margin-top: 130px;">{{ $r->user_id }}</h5>
                                            <p class="card-text">{{ $r->star_rating }}</p>
